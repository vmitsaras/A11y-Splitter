...
const docs = {
	...
	description: "Accessible, dependency-free text splitting for graphemes, words, and rendered lines.",
...
if (root instanceof HTMLElement) {
  createTextSplit(root, { type: "words" });
	...
	examples: [
		{
			name: "Basic",
			description: "Core semantic and visual splitting.",
			path: "examples/basic"
		},
		{
			name: "Kinetic poster",
			description: "Pointer-reactive letters.",
			path: "examples/kinetic-poster"
		},
		{
			name: "Line reveal",
			description: "Responsive rendered lines.",
			path: "examples/line-reveal"
		},
		{
			name: "Word spotlight",
			description: "Pointer-focused semantic words.",
			path: "examples/word-spotlight"
		},
		{
			name: "Type wave",
			description: "A controllable letter wave.",
			path: "examples/type-wave"
		},
		{
			name: "Letter cascade",
			description: "Scroll-driven decorative letters.",
			path: "examples/scroll-letter-cascade"
		},
		{
			name: "Word drift",
			description: "Scroll-enhanced semantic words.",
			path: "examples/scroll-word-drift"
		},
		{
			name: "Line chapters",
			description: "Once-only line reveals.",
			path: "examples/scroll-line-chapters"
		},
		{
			name: "Exit echo",
			description: "Bidirectional scroll reveals.",
			path: "examples/scroll-exit-echo"
		},
		{
			name: "Orbit poem",
			description: "Pointer-driven word orbit.",
			path: "examples/orbit-poem"
		},
		{
			name: "Mood mixer",
			description: "User-selected sentence variants.",
			path: "examples/mood-mixer"
		},
		{
			name: "Signal loom",
			description: "Range-controlled word emphasis.",
			path: "examples/signal-loom"
		},
		{
			name: "Trust current",
			description: "Dependency-free horizontal scroll scene.",
			path: "examples/trust-current"
		},
		{
			name: "Mouse mischief",
			description: "Pointer-reactive decorative words.",
			path: "examples/mouse-mischief"
		},
		{
			name: "Neo-brutal split",
			description: "Live poster controls.",
			path: "examples/neo-brutalism"
		}
	]
};
